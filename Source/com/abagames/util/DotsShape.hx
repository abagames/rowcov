...
class DotsShape {
	public static inline var DOT_SIZE = 4;
	public var bd:BitmapData;
	public var rect:Rectangle;
	public var size:Vector;
	public function new(pattern:DotsPattern, colors:Array<Color>) {
		rect = new Rectangle();
		...
		var dr:Rectangle = new Rectangle(0, 0, DOT_SIZE * 0.5, DOT_SIZE * 0.5);
		for (y in 0...yc) {
			for (x in 0...xc) {
				...
				dr.x = x * DOT_SIZE;
				dr.y = y * DOT_SIZE;
				bd.fillRect(dr, 0xff000000 + colors[ci - 1].i);
			}
		}
